...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(label="Consulta", command=self.controle.consultaEstudantes)
        ...
        self.turmaMenu.add_command(label="Insere", command=self.controle.insereTurmas)
        self.turmaMenu.add_command(label="Mostra", command=self.controle.mostraTurmas)
        self.turmaMenu.add_command(label="Consulta", command=self.controle.consultaTurmas)                     
...
class ControlePrincipal():       
    ...
    def insereEstudantes(self):
        self.ctrlEstudante.insereEstudantes(self.root)
    ...
    def insereTurmas(self):
        self.ctrlTurma.insereTurmas(self.root)
